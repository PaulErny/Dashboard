...
namespace Example.API.Repositories
{
    public sealed class ElementRepository : IElementRepository
    {
        ...
        private readonly DbContextOptions<ExampleContext> _options;

        #endregion MEMBERS

        #region CONSTRUCTORS

        public ElementRepository(ILogger<IElementRepository> logger, DbContextOptions<ExampleContext> options)
        {
            _logger = logger;
            _options = options;
        }
